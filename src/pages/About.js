...
function About() {
  return (
    ...
    <div className="py-10">
      ...
      <h2 className="text-xl text-slate-200 font-sans font-semibold">Enthusia is VJTI’s annual sports festival, generally held in the month of December. Enthusia has inter-college as well as intra-college events in
